...
-- ALWAYS explicitly create under schema
...
CREATE TABLE RESERVATION.HISTORY (
  ...
  CONSTRAINT FK_HISTORY_CUSTOMER
    FOREIGN KEY (MAILID) REFERENCES RESERVATION.CUSTOMER(MAILID)
);

COMMIT;

-- seed data
INSERT INTO RESERVATION.ADMIN VALUES
('admin@demo.com','admin','System','Admin','Demo Address','9874561230');

INSERT INTO RESERVATION.CUSTOMER VALUES
('shashi@demo.com','shashi','Shashi','Raj','Kolkata',954745222);

INSERT INTO RESERVATION.TRAIN VALUES
